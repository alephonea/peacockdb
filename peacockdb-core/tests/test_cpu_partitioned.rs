...
cpu_partitioned_result_test!(tpch, 1, q6, tp8_standard, data_fusion_exact, result_golden);
...
cpu_partitioned_result_test!(tpch, 1, shuffle_additive, tp8_standard, data_fusion_exact, result_golden);
// shuffle_additive_avg: real 8-way with an AVG (state = sum,count merged Σsum/Σcount
// per hash bucket). Minimal single-avg carrier.
cpu_partitioned_result_test!(tpch, 1, shuffle_additive_avg, tp8_standard, data_fusion_exact, result_golden);
// q1: the canonical AVG carrier (3 avgs + 4 sums + count, GROUP BY rf,ls) — real
// 8-way at tp8-standard. tp8-mini q1 stays full-table.
cpu_partitioned_result_test!(tpch, 1, q1, tp8_standard, data_fusion_exact, result_golden);
...
cpu_partitioned_result_test!(tpch, 1, join_int, tp8_standard, data_fusion_exact, no_result_golden);
...
cpu_partitioned_result_test!(tpch, 1, semi_join, tp8_standard, data_fusion_exact, no_result_golden);
cpu_partitioned_result_test!(tpch, 1, anti_join, tp8_standard, data_fusion_exact, no_result_golden);
cpu_partitioned_result_test!(tpch, 1, left_join, tp8_standard, data_fusion_exact, no_result_golden);
...
cpu_partitioned_result_test!(tpch, 1, q3, tp8_standard, data_fusion_exact, result_golden);
cpu_partitioned_result_test!(tpch, 1, q5, tp8_standard, data_fusion_exact, result_golden);
...
cpu_partitioned_result_test!(tpch, 1, q7, tp8_standard, data_fusion_exact, result_golden);
cpu_partitioned_result_test!(tpch, 1, q8, tp8_standard, data_fusion_exact, result_golden);
cpu_partitioned_result_test!(tpch, 1, q9, tp8_standard, data_fusion_exact, result_golden);
// q12/q19: Partitioned Inner, int keys, mergeable sum, no LIMIT/decimal/distinct.
cpu_partitioned_result_test!(tpch, 1, q12, tp8_standard, data_fusion_exact, result_golden);
cpu_partitioned_result_test!(tpch, 1, q19, tp8_standard, data_fusion_exact, result_golden);
...
cpu_partitioned_result_test!(tpch, 1, q13, tp8_standard, data_fusion_exact, result_golden);

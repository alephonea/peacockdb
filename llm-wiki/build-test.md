...
**Grand total: 1662 test cases — Rust 1228, C++ 65, Python 369.** The Python figure includes the 93 corpus queries, which only a manual dispatch runs.

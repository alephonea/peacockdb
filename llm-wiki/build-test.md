...
**Grand total: 1362 test cases — Rust 956, C++ 37, Python 369.** The Python figure includes the 93 corpus queries, which only a manual dispatch runs.
...
| Lib unit (Rust) | config tiers, batch-size rule, resident model, and the batch-partitioned types, schema annotations and validation rules | [tiers_are_strictly_increasing](../peacockdb-core/src/config.rs#L119), [nested_join_build_sides_stack](../peacockdb-core/src/resident.rs#L165) | cpp-cpu | 186 |

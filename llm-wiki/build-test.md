...
**Grand total: 1562 test cases — Rust 1128, C++ 65, Python 369.** The Python figure includes the 93 corpus queries, which only a manual dispatch runs.
...
the 1562. Everything else in the repo that can be enumerated as a test case is counted.
